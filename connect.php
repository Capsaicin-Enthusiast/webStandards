        ...
        <div class="container mx-auto py-4 flex items-center justify-between">
            ...
            <nav>
                <ul class="flex">
                    ...
                    <li><a href="connect.html" class="px-4 py-2 text-gray-1000 font-bold">Connect</a></li>
    ...
    <main class="container mx-auto py-5">
        <section id="connect" class="text-center">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <a href="https://testtkitchen.blogspot.com/" target="_blank"  class="hover:no-underline">
                    <div class="max-w-md rounded overflow-hidden shadow-lg bg-white">
                        <div class="px-6 py-4">
                            <h2 class="text-2xl font-bold text-gray-800 mb-4">Blogger</h2>
                            <img src="img/blogger-icon.webp" alt="Blogger Icon" class="mx-auto mb-4">
                        </div>
                    </div>
                </a>
                <a href="https://www.facebook.com/profile.php?id=61556943237299" target="_blank"  class="hover:no-underline">
                    <div class="max-w-md rounded overflow-hidden shadow-lg bg-white">
                        <div class="px-6 py-4">
                            <h2 class="text-2xl font-bold text-gray-800 mb-4">Facebook</h2>
                            <img src="img/facebook-icon.png" alt="Facebook Icon" class="mx-auto mb-4">
                        </div>
                    </div>
                </a>         
            </div>
