...
<body>
  <div class="min-h-screen flex justify-center items-center">
    <div class="bg-white shadow-md rounded-md p-8 max-w-md w-full">
        <h5 class="text-center text-lg font-semibold mb-6">Register</h5>
        <form id="register" class="form" method="post" name="register">
            <div class="mb-6">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="email" class="form-control pl-10 pr-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring focus:border-blue-300 w-full" name="email" id="email" placeholder="Email" required>
                </div>
            </div>
            <div class="mb-6">
